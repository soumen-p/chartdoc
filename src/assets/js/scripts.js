...
jQuery(function($) {
    ...
    CMPLTADMIN_SETTINGS.onLoadTopBar = function() {
            ...
            $(".page-topbar .message-toggle-wrapper1").addClass("showopacity");
            $(".page-topbar .notify-toggle-wrapper1").addClass("showopacity");
            $(".page-topbar .searchform1").addClass("showopacity");
            $(".page-topbar li.profile1").addClass("showopacity");
    }
